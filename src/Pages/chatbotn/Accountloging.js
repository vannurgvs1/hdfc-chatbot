...
const Accountloging = ({ setLogin, setCustomerLogin }) => {
  ...
  return (
    <div className="ac-wrapper">
      <Box>
        <div className="ac-wrapperborder">
          <div className="loginborder">
            <Paper_Core className="cl-grid" width={326} padding={1.5}>
              <Grid container>
              ...
              <Grid>
                ...
                >
                  <Grid item sm={3}>
                    <InputLabel className="cl-label">EnterOTP</InputLabel>
                  </Grid>
                  <Grid item sm={5}>
                    <TextField
                      color="warning"
                ...
                {errors.captcha && (
                  <p className="err-field"> {errors.captcha}</p>
                )}
              </Grid>
            </Paper_Core>
          </div>
